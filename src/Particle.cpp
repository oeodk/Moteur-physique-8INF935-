...
Particle::Particle(Vector3D init_pos, Vector3D init_vel, Vector3D init_acc, float mass, Vector3D color, float alpha)
	: _position(init_pos), _velocity(init_vel), _acceleration(init_acc), _color(color), _alpha(alpha) {
